...
class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    void addData(String nama,  String alamat, int nik, String tempat_lahir, String tanggal_lahir, String agama, String nomor_telepon, String kepala_keluarga){
    ...
    void updateData(String row_id, String nama, String alamat, int nik, String tempat_lahir, String tanggal_lahir, String agama, String nomor_telepon, String kepala_keluarga){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put(COLUMN_NAMA, nama);
        cv.put(COLUMN_ALAMAT, alamat);
