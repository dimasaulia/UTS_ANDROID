...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    CustomAdapter(Activity activity, Context context, ArrayList penduduk_id, ArrayList nama, ArrayList alamat, ArrayList nik, ArrayList tempat_lahir, ArrayList tanggal_lahir, ArrayList agama, ArrayList telepon, ArrayList kepala_keluarga){
